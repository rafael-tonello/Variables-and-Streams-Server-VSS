...
namespace API
{
    ...
    {
    public:
        virtual future<void> createAlias(string name, string value) = 0;
        virtual future<void> observateVar(string varname, void* API, string observerInternalId) = 0;

        //the JsPromise (from ThreadPool) will no be used yet because this must be tested
        /*
        ...
        */
        ...
        virtual future<void> setVar(string name, string value) = 0;
